...
public interface LoginApi {
    ...
    @ApiOperation(value = "Login S&D APP", nickname = "login", notes = "", response = LoginResponse.class, tags={ "Login", })
    @ApiResponses(value = { 
