...
public interface NotesApi {
    ...
    @ApiOperation(value = "get newest data from backend by lastupdatetime", nickname = "getNotesByLastupdateDateTime", notes = "", response = NotesGetResponse.class, tags={ "Notes (synch API)", })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "Success", response = NotesGetResponse.class),
