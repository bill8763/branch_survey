...
public interface MessageApi {
    ...
    @ApiOperation(value = "Fetch newsest data from backend", nickname = "pullMessage", notes = "", response = MessageGetResponse.class, tags={ "Message (synch API)", })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "Success", response = MessageGetResponse.class),
