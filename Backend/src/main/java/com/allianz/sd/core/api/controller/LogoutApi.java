...
public interface LogoutApi {
    ...
    @ApiOperation(value = "Logout S&D APP", nickname = "logout", notes = "", response = LogoutResponse.class, tags={ "Login", })
    @ApiResponses(value = { 
        @ApiResponse(code = 202, message = "Accepted", response = LogoutResponse.class),
