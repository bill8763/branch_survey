...
@Api(value = "deviceChange", description = "the deviceChange API")
public interface DeviceChangeApi {

    @ApiOperation(value = "Update Device Status", nickname = "deviceChange", notes = "", response = GenerationResponse.class, tags={ "Login", })
    @ApiResponses(value = { 
