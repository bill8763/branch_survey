...
@Api(value = "AgencyPlan", description = "the AgencyPlan API")
public interface AgencyPlanApi {

    @ApiOperation(value = "Fetch agent's AgencyPlan from backend", nickname = "getAgencyPlan", notes = "", response = AgencyPlanGetResponse.class, tags={ "AgencyPlan", })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "Success", response = AgencyPlanGetResponse.class),
