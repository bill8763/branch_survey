...
import com.allianz.sd.core.api.model.SubmitGoalRequest;
import com.allianz.sd.core.api.model.SubmitGoalResponse;
...
@Api(value = "SubmitGoal", description = "the SubmitGoal API")
public interface SubmitGoalApi {

    @ApiOperation(value = "Agent submit the goal", nickname = "submitTheGoal", notes = "", response = SubmitGoalResponse.class, tags={ "Goal", })
    @ApiResponses(value = { 
        @ApiResponse(code = 202, message = "Accepted", response = SubmitGoalResponse.class),
    ...
    @RequestMapping(value = "/SubmitGoal",
