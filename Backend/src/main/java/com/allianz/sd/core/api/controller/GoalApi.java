...
public interface GoalApi {
    ...
    @ApiOperation(value = "Fetch agent's Goal setting data from backend", nickname = "pullGoal", notes = "", response = GoalGetResponse.class, tags={ "Goal", })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "Success", response = GoalGetResponse.class),
