...
public interface ErrorLogApi {
    ...
    @ApiOperation(value = "Add S&D error log", nickname = "errorLog", notes = "", response = GenerationResponse.class, tags={ "Unfunctional", })
    @ApiResponses(value = { 
