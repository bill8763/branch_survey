...
public interface ConfigurationApi {
    ...
    @ApiOperation(value = "Fetch agent's configuration from backend", nickname = "pullConfiguration", notes = "", response = ConfigurationGetResponse.class, tags={ "Configuration", })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "Success", response = ConfigurationGetResponse.class),
