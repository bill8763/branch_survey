...
@Api(value = "customerprofiles", description = "the customerprofiles API")
public interface CustomerprofilesApi {

    @ApiOperation(value = "Fetch newsest data from backend", nickname = "pullCustomer", notes = "", response = CustomerProfileGetResponse.class, tags={ "Customer Profile (synch API)", })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "Success", response = CustomerProfileGetResponse.class),
