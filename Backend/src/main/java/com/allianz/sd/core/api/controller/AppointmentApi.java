...
public interface AppointmentApi {
    ...
    @ApiOperation(value = "get ists newest data from backend by lastupdatetime", nickname = "getAppointmentsByLastUpdateDateTime", notes = "", response = AppointmentGetResponse.class, tags={ "Appointment (synch API)", })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "Success", response = AppointmentGetResponse.class),
