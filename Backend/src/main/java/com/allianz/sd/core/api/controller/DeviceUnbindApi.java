...
@Api(value = "deviceUnbind", description = "the deviceUnbind API")
public interface DeviceUnbindApi {

    @ApiOperation(value = "Unbind Device Status", nickname = "unbindingDevice", notes = "", response = GenerationResponse.class, tags={ "Login", })
    @ApiResponses(value = { 
