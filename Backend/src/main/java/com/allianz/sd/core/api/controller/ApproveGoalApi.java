...
@Api(value = "ApproveGoal", description = "the ApproveGoal API")
public interface ApproveGoalApi {

    @ApiOperation(value = "Leader approve the goal", nickname = "approveTheGoal", notes = "", response = GenerationResponse.class, tags={ "Goal", })
    @ApiResponses(value = { 
    ...
    @RequestMapping(value = "/ApproveGoal",
