...
@Api(value = "AppClickLog", description = "the AppClickLog API")
public interface AppClickLogApi {

    @ApiOperation(value = "Add S&D app click log", nickname = "appClickLog", notes = "", response = GenerationResponse.class, tags={ "Unfunctional", })
    @ApiResponses(value = { 
    ...
    @RequestMapping(value = "/AppClickLog",
